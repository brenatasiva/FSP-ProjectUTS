...
include "db.php";
require_once("class1/movie.php");
require_once("class1/genre.php");
require_once("class1/poster.php");
require_once("class1/pemain.php");
...
<?php  
		...
		<div class="title">
			<div class="picture"><?php 
							echo "<img src='images/".$arr_kumpulan_gambar[0]."'>";
						?></div>
			<div class="attr">
